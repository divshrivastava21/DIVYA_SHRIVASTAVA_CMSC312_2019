...
public class MultiThreading4 extends Process implements Runnable{

    public MultiThreading4(int input, File file, int memoryNeeded, int memoryNeededKB, int framesNeeded, int pagesNeeded,
        ...
        while (scan.hasNextLine()) {
            ...
            if (word.equals("CALCULATE") || word.equals("I/O")) {
                ...
                arr[i] = numInt + (int) (getRandomInt(numInt * (-0.6), numInt * (0.6)));
        ...
        burstTimeCPU[j] = 4; /*(int) getRandomInt(1, 20);*/
